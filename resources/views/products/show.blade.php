...
<div class="container">
    ...
    <dl class="row mt-3" >
        ...
        <dd class="col-sm-9">{{ $product->id }}<span>.</span></dd>
        ...
        <dd class="col-sm-9"><span>￥</span>{{ $product->price }}</dd>
    ...
    <a href="{{ route('products.edit', $product) }}" class="btn btn-warning " style="background-color:#fd7e14">編集</a>
